    ...
    client.on('voiceStateUpdate', (oldState, newState) => {
        ...
        // 2. المستخدم غادر القناة الصوتية كلياً (من قناة إلى لا شيء)
            ...
            if (existingSession) {
                ...
                const timeResult = trackUserActivity(userId, 'voice_time', { 
        ...
        // 3. المستخدم انتقل بين القنوات (من قناة إلى قناة أخرى)
            ...
            if (existingSession) {
                ...
                console.log(`⏱️ تم حفظ ${Math.round(sessionDuration / 1000)} ثانية من القناة ${existingSession.channelName}`);
            }
        ...
        setTimeout(() => {
            try {
                ...
                const stats = getRealUserStats(userId);
