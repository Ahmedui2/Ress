    ...
    async execute(message, args, { BOT_OWNERS }) {
        try {
            ...
            const sendMainEmbed = async (msgOrInteraction) => {
                ...
                try {
                    const isButton = typeof msgOrInteraction.isButton === 'function' ? msgOrInteraction.isButton() : false;
                    if (isButton && (msgOrInteraction.replied || msgOrInteraction.deferred)) {
